...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        ...
        let activeType = 'inquiry'; // Default type
        ...
        typeOptions.forEach(option => {
            option.addEventListener('click', () => {
                ...
                complaintDetails.classList.remove('visible');
                suggestionDetails.classList.remove('visible');
                generalMessage.classList.remove('visible');

                // Show the relevant textarea
                if (activeType === 'complaint') {
                    complaintDetails.classList.add('visible');
                } else if (activeType === 'suggestion') {
                    suggestionDetails.classList.add('visible');
                } else {
                    generalMessage.classList.add('visible');
                }
            });
        });
        // Set default active option
         const defaultOption = document.querySelector('.type-option[data-type="inquiry"]');
        if(defaultOption) {
        ...
        contactForm.addEventListener('submit', function(event) {
            ...
            if (name && phone) {
                ...
                contactForm.reset();
                // Reset type options and textareas
                typeOptions.forEach(o => o.classList.remove('active'));
